...
- `npm test` e `npm run test:e2e` no `backend/` (o e2e sobe um Postgres embarcado, não precisa
  de Docker nem de configuração extra)
- `npm run lint` no `backend/` e no `frontend/`, conforme o que você mudou
