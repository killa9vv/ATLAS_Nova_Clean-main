...
function renderQtyRow() {
  ...
  document.getElementById('detail-qty-row').innerHTML =
    qty === 0
...
function renderDetail() {
  ...
  document.getElementById('detail-precautions').textContent =
    v.precautions || defaults.precautions || '—';
