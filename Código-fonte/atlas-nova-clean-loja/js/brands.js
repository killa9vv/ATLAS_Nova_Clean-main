...
export function renderBrandView(brand) {
  ...
  document.getElementById('brand-view-eyebrow').textContent =
    `${items.length} ${items.length === 1 ? 'produto' : 'produtos'} dessa marca`;
  document.getElementById('brand-view-grid').innerHTML =
